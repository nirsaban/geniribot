...
export const he = {
  ...
  copyLink: "העתק",
  chargeSavedCard: "חייב סכום",
  chargeAmountPlaceholder: "סכום בש\"ח",
  chargeDescPlaceholder: "תיאור החיוב",
  chargeNoSavedCard: "אין כרטיס שמור",
  chargeSuccess: "חויב בהצלחה ✅",
  chargeFailed: "החיוב נכשל",
  checkoutMissingPhone: "יש להוסיף מספר טלפון בהגדרות הצוות לפני שדרוג מסלול",
  ...
  growCreateCheckoutUrl: "Webhook ליצירת תשלום (Create Checkout)",
  growVerifyUrl: "Webhook לאימות ואישור עסקה (Verify + Approve)",
  growChargeTokenUrl: "Webhook לחיוב טוקן שמור (אופציונלי)",
  saveSecret: "שמור מאובטח",
  secretSaved: "נשמר מוצפן ✅",
  secretSet: "מוגדר",
  secretNotSet: "לא הוגדר",
  removeSecret: "הסר",
  howToGetGrow: "איך מחברים את Grow דרך Make?",
  growStep1: "ב-Make.com צור/י תרחיש (scenario) עם Webhook מסוג Custom webhook, ואחריו מודול Grow ← Make an API Call, המחובר לחשבון ה-Grow שלך (המחובר לפי ת.ז/ח.פ + טלפון).",
  growStep2: "הוסיפ/י מודול Webhook response שמחזיר את תשובת ה-JSON הגולמית של Grow. חזור/י על כך פעם אחת לכל אחת מהפעולות: createPaymentProcess, getPaymentProcessInfo, approveTransaction (ואופציונלי createTransactionWithToken).",
  growStep3: "הדבק/י כאן את כתובת ה-Webhook של כל תרחיש ולחצ/י \"שמור מאובטח\". הכתובות מוצפנות ואינן נחשפות.",
