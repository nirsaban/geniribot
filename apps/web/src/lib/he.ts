...
export const he = {
  ...
  productsTitle: "מוצרים ושירותים",
  productsSubtitle: "כל מוצר או שירות מקבל תמונות, בוט משלו, ולידים משלו",
  productNamePlaceholder: "שם המוצר/שירות",
  newProduct: "מוצר חדש",
  noProducts: "עדיין לא הוספת מוצרים או שירותים",
  productsLimitReached: "הגעת למספר המוצרים המקסימלי במסלול הנוכחי",
  productFlowsCount: "בוטים",
  productLeadsCount: "לידים",
  editProduct: "עריכה",
  backToProducts: "→ חזרה למוצרים",
  productDetailsTitle: "פרטי המוצר",
  productNameLabel: "שם",
  productDescriptionLabel: "תיאור",
  productPriceLabel: "מחיר (₪, ריק = ללא מחיר קבוע)",
  saveProduct: "שמירה",
  productStatusLabel: "סטטוס",
  productStatusDraft: "טיוטה",
  productStatusActive: "פעיל (גלוי לציבור)",
  productStatusArchived: "בארכיון",
  productPublicLinkTitle: "קישור ציבורי",
  productPublicLinkHint: "הדף הזה גלוי ללקוחות רק כשהמוצר במצב פעיל",
  productImagesTitle: "תמונות",
  productFlowsTitle: "בוטים למוצר הזה",
  productNoFlows: "אין עדיין בוט שמשויך למוצר הזה",
  productAddFlow: "+ בוט חדש למוצר",
  productLeadsTitle: "לידים",
  productViewLeads: "צפה בלידים של המוצר",
  deleteProduct: "מחיקת מוצר",
  deleteProductConfirm: "למחוק את המוצר לצמיתות? הבוטים והלידים יישארו, רק השיוך למוצר יוסר.",
